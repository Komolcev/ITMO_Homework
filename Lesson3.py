...
# Комментарий Жени:
# Когда ты используешь i in range, в будущем тебе придется обращаться к элементу с индексом i
# a = [5, 7, 9]
# for i in range(0, len(a)): —— i каждый раз будет меняться и будет 0, 1, 2
# print(a[i]) —— программа каждый раз будет выводить элементы массива а, так как ты обращаешься к элементу с индексом каждый раз на еденицу больше
