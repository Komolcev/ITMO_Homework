# Импортировал метод рандом ради шутки, забавно наблюдать, как ученики получают разные оценки.
# Всего есть 3 ученика, каждый из этих трех учеников получает рандомную оценку по каждой из двух данных ему задач.
import random
